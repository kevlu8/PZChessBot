...
API::Events::Events() {
	...
	request = cpr::GetAsync(cpr::Url{REQUEST_URL + "/api/stream/event"}, cpr::Bearer{TOKEN}, cpr::WriteCallback{callback, nullptr});
}
...
bool API::Events::callback(std::string header, intptr_t userdata) {
