...
#define RFP_THRESHOLD (140 * CP_SCALE_FACTOR)
#define RFP_IMPROVING (29 * CP_SCALE_FACTOR)
...
#define ASPIRATION_WINDOW (28 * CP_SCALE_FACTOR)
...
#define DELTA_THRESHOLD (297 * CP_SCALE_FACTOR)

// Futility pruning threshold
// This is the threshold for futility pruning (in centipawns)
#define FUTILITY_THRESHOLD (285 * CP_SCALE_FACTOR)
#define FUTILITY_THRESHOLD2 (686 * CP_SCALE_FACTOR)

// Razoring margin
// This is the margin for razoring (in centipawns)
#define RAZOR_MARGIN (251 * CP_SCALE_FACTOR)

// History pruning margin
// This is the margin for history pruning (in centipawns)
#define HISTORY_MARGIN (3793 * CP_SCALE_FACTOR)
